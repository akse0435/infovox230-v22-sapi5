...
Name: "{group}\Speak a test sentence";  Filename: "{app}\Infovox230SapiTest.exe"; Parameters: "say"; Comment: "Says how many Infovox voices are installed, to check they are working"
